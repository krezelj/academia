...
logging.basicConfig(
    ...
    datefmt='%Y-%m-%d %H:%M:%S',
    filename='experiments/experiment_1/run_0.03.log',
)
...
for i in range(N_RUNS - iter):
    ...
    curriculum = Curriculum(tasks=[task_lvl_0, task_lvl_1, task_lvl_2],
                            output_dir=f'experiments/experiment_1/outputs/eps=0.03/curriculum_iter={iter}')
    curriculum.save('experiments/experiment_1/configs/eps=0.03/curriculum_iter={iter}')
